...
//  $cnt->faux_construct(NULL, 1, $_POST['nom'], $_POST['prenom'], $_POST['adresse'], $_POST['mail'], $_POST['age'], $_POST['tel']);
...
//var_dump($cnt);
//$cnt->faux_construct(NULL, 1, "billllll", "Bertrandddd", NULL, "Bertranddvd@gmail.fr", NULL, NULL);
//var_dump($cnt);
//$dao->setContact($cnt);
  echo "success";
?>
