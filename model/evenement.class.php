<?php
	...
	// converti l'évenement en string avec un format particulier pour le transmettre au client
	public function toStringArray() {
	    ...
	    $stringArray = "";
	    foreach ($array as $key => $value) { // format : 'clé#valeur&clé#valeur&'
		$stringArray = $stringArray+$key+'#'+$value+'&';
	    }
